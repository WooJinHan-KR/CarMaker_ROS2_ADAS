...
// CM ROS example - Topic Interface
void CMNodeHelloCM::SubscribeCallback(std_msgs::msg::String::ConstSharedPtr msg) {
...
// CM ROS example - Topic Interface
void CMNodeHelloCM::PublishCallback(std_msgs::msg::String& msg) {
...
// CM ROS example - Topic Interface
	typedef CMJob::RosSubscriber<std_msgs::msg::String> User_Sub;
	...
	typedef CMJob::RosPublisher<std_msgs::msg::String> User_Pub;
