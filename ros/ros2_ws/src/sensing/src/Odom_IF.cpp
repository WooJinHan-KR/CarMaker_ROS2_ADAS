...
int
CMNode_Odom_IF_TestrunStartAtEnd(cm_ros::CMNode *CMNode)
{
    typedef CMJob::RosPublisher<nav_msgs::msg::Odometry> Odometry_Data;
...
int
CMNode_Odom_IF_TestrunEnd(cm_ros::CMNode *CMNode)
{
    CMJob::JobScheduler& scheduler = CMNode->getScheduler();

    scheduler.deleteJob("Odometry_Data");
}
